...
sleep 2
echo "tip : cpu0/cpu1 online only for power save in ftm mode"
...
echo 0 > /sys/kernel/tracing/tracing_on && echo "" > /sys/kernel/tracing/trace && sleep 1 && echo 1 > /sys/kernel/tracing/tracing_on && sleep 50 && echo 0 > /sys/kernel/tracing/tracing_on && cat /sys/kernel/tracing/trace > /mnt/vendor/oplusreserve/ftm_admin/trace.txt&
